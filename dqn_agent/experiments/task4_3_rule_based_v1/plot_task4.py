...
from common.plots.task4 import create_figure_task4  
...
if __name__ == "__main__":
    ...
    if metrics_data:
        ...
        # Task 4 Plot
        fig_task4 = create_figure_task4(metrics_data)
        task4_save_path = output_dir / "task4_metrics.png"
        fig_task4.savefig(task4_save_path, dpi=300)
